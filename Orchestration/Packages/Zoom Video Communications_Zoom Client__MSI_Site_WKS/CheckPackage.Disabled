...
Param()
#Zoom Video Communications_Zoom Client__MSI_Site_WKS
#Check for new versions of Zoom Client.
#
#1. Get old versions
...
$PackageProperties | Select-NewerPackageVersion | New-AppPackageManifest
